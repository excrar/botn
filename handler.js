      ...
      if (isCommand) {
        ...
        switch (actualCommand) {
          ...
          case 'tes':
            ...
            conn.sendMessage("120363400980954557@g.us", {
              text: args.join(' ')
            });
            break
          case 'hidetag':
          ...
          case 'addstok':
            ...
            try {
              ...
              const channelId = "120363400980954557@g.us";
